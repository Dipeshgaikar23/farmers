...
const ThreeJSBackground = () => {
  useEffect(() => {
    ...
    const fieldGeometry = new THREE.PlaneGeometry(100, 100, 20, 20);
    ...
    function createQRCube(x, y, z) {
      ...
      const line = new THREE.LineSegments(edges, new THREE.LineBasicMaterial({ color: 0x8cc084 }));
  ...
  return <div id="canvas-container" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100vh', zIndex: -1 }} />;
};
